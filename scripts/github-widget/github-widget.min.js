if (check_arg() == false) {if(typeof(document.getElementById("disabled_api")) != 'undefined' && document.getElementById("disabled_api") != null) {document.getElementById("disabled_api").style.display = "block";}}
else {
	//github-widget.min.js start		
		/*
